    ...
    return (
        <>
            ...
            <div className="pro-card">
                ...
                <div className="prpra">
                    <div className="aqwasq1">
                        <input type="text" name="" id="" placeholder="Find a repositrty..." className="yourreop"  value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)} />
                     <div className="aasqqksq">
                     <button  className="yurt">Type</button><button className="yurt">Language</button><button className="yurt">Sort</button>    
                     </div>
                     <button className="reabtn" id="eera">
                            <i className="fa-solid fa-book"></i> New
                        </button>
                    </div>
                    <div className="pro-repositories">

                        <div className="pro-repo-list1">
                        {filteredRepos.length > 0 ? (
                    filteredRepos.map((repo) => (
                        <div key={repo.id} className="pro-repo-item2">
                            <div className="asass">
                                {/* Language Color Indicator */}
                                <a href="" className="akl">
                                    <span className="pro-repo-name">{repo.name}</span>
                                </a>
                                  <button className="yrt"><i className="fa-regular fa-star"></i> stars</button>
                            </div>
                            <br /><br />
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                ></span>
                                <span className="pro-repo-language">
